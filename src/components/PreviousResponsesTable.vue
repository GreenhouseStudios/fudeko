<template>
    <div class="">
        ...
        <DataTable :value="joinedResponses" class="" sortField="created_at" :sortOrder="-1">
            ...
            <Column field="share" header="Share Option"></Column>
    ...
    computed: {
        ...
        joinedResponses() {
            return this.responses.map(r => {
                if (r.participant == this.participants.find(p => p.email == this.userEmail)?.id) {
                    return {
                        ...r,
                        ...
                        difficulty: r.response_difficulty || 'None Selected',
                        share: r.share_option || 'None Selected',
