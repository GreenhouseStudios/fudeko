<template>
    <div class="py-48">
        <h2 class="text-xl font-bold"> Thank you for your submission!</h2>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        //     }
        //     this.submitResponse( { response: this.response, difficulty: this.difficulty, shareOption: this.shareOption } )
